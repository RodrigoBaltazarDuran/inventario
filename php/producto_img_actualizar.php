<?php
    ...
    // Verificamos formato de imagenes
    ...
    if ($actualizar_producto->execute($marcadores)) {
        echo '
            <div class="notification is-info is-light">
                <strong>¡IMAGEN O FOTO ACTUALIZADA!</strong>
                <br>
                La imagen del producto se actualizo con éxito, pulse Aceptar para recargar los cambios
        ...
        echo '
            <div class="notification is-danger is-light">
                ...
                <br>
                No podemos subir la imagen en este momento, por favor intene nuevamente
            </div>
        ';
    }
